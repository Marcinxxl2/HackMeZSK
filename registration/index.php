    ...
    <form action="registration.php" method="POST" id="regisForm">
        <div class="regisSide">
            ...
            <div id="regisRegulations">
                <label for="regulationsCheckbox">Zaakceptuj</label> <a href="../includes/docs/regulamin_strony.pdf" target="_blank" id="regulationsLink">regulamin</a>: <input type="checkbox" name="regulations" value="accepted" id="regulationsCheckbox" autocomplete="off">
...
<?php 
    require_once $_SERVER['DOCUMENT_ROOT'].'/HackMeZSK/includes/php/htmlphp/afterContent.php'; 
?>