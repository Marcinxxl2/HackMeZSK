...
<div id="content">
    ...
    <?php
        ...
        try {
            ...
            if ($result = $conn->customQuery('SELECT levels.level_id, levels.level_name, levels.description, levels.points, levels.link FROM levels INNER JOIN categories on levels.category_id = categories.category_id WHERE categories.category_name = "SQL"')) {
